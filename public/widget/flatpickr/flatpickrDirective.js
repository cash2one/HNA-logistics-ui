...
(function (global, factory) {
    ...
    function FlatpickrInstance(element, instanceConfig) {
        ...
        self.toggle = toggle;
        self.resetDefaultDate = function(inputVal) {
            if(!inputVal) return;
            var timeVals = inputVal.split(":");
            self.config.defaultHour = self.hourElement.value = pad(timeVals[0]);
            self.config.defaultMinute = self.minuteElement.value = pad(timeVals[1]);
        };
